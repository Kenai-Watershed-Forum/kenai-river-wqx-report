...
i = 1
s = paste0('title: "Kenai River Water Quality Assessment (', c('Bootstrap', 'Tufte'), ' Style)"')
for (fmt in c('html_book', 'tufte_html_book')) {
  ...
  i = i + 1
  bookdown::publish_book(paste0('Kenai-River-Water-Quality-Assessment', i))
}
unlink('_book', recursive = TRUE)
...
bookdown::publish_book(name = 'Kenai-River-Water-Quality-Assessment', account = "kwfwqx")
