...
sgs21_sitenames <- data.table(unique(sgs21$`Client Sample`)) %>%
  # filter out names containing the suffixes "DUP" (duplicate) or Diss/Dis (Dissolved metals sample) since we only want a list of unique sites
...
# Using these two lists, we will manually create a new file titled "site_names_matching_table_manual_edit.xlsx" and match up the two disparate naming systems
