...
# before proceeding here, we want to see if we can acquire other associated data regarding ALS samples
...
Download Original 2021 Fecal Coliform Lab Results (Click Link)


```{r, echo = F}
xfun::embed_file('other/input/2021_wqx_data/spring_2021_wqx_data/SWWTP/KRWF Fecal 05-11-21.xls', text = "Download Original Spring 2021 Fecal Lab Results from SWWTP")
...
```{r, echo = F}
xfun::embed_file('other/input/2021_wqx_data/spring_2021_wqx_data/SWWTP/KRWF TSS MONITORING 05-11-21.xls', text = "Download Original Spring 2021 Total Suspended Solids Results from SWWTP.xls")
```

```{r, echo = F}
xfun::embed_file('other/input/2021_wqx_data/summer_2021_wqx_data/SWWTP/KRWF TSS MONITORING 07-28-21.xls', text = "Download Original Summer 2021 Total Suspended Solids Results from SWWTP.xls")
```
...
```{r}
# SWWTP Spring 2021 data
## Reformat TSS data to match AQWMS template
swwtp_tss_spring21 <- read_excel('other/input/2021_wqx_data/spring_2021_wqx_data/SWWTP/KRWF TSS MONITORING 05-11-21.xls', skip = 1) %>%
  clean_names()

swwtp_tss_summer21 <- read_excel('other/input/2021_wqx_data/summer_2021_wqx_data/SWWTP/KRWF TSS MONITORING 07-28-21.xls', skip = 1) %>%
  clean_names()
