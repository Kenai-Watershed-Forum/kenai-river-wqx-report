...
sgs21_als21_qaqc_dat <- dat %>%
    # retain only results not from field sampling program
   filter(!sample_type %in% c("PS","SMPL"))
...
# working here (below) 3/28/22 -- need to apply distinction to field vs lab duplicates. see explanation at line 255 !!!
