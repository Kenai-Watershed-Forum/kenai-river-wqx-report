...
actual_tripd_blanks_2021 <- actual_blanks_dups_2021 %>%
  filter(activity_type == "Quality Control Sample-Trip Blank") %>%
  count() %>%
  as.character()
...
# WORKING HERE 5/24/2022

# NEXT::: match against standards from QAPP; advocate for where exceptions should be addressed (eg for FC; count 1 vs 2 = 50% rpd)
# 5/24/2022 - IN PROCESS OF SETTING UP TABLE FOR RPD ASSESSMENT STANDARDS
# SET UP DATA ENTRY FOR 2013 - 2016 FOR JACK... in progress
...
From the above downloadable file, "Planned vs. Actual Trip Blank and Field Duplicate Samples for 2021," we observe that data from one field duplicate sample is missing. The missing sample is for the 200.7 (total metals) analyses on 2021-05-11 ar RM 31 (Morgan's Landing). This error occurred due to a transcription error on the chain of custody form.
