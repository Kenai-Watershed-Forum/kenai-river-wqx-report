...
als21 %<>%
  ...
  transform(lab_sample = as.double(lab_sample),
...
sgs21 %<>%  
  ...
  # also remove "Diss" suffix from "analysis" column
...
z <- sgs21 %>%
  ...
  mutate(
    ...
    #`Result Analytical Method ID` = rename analysis
    #`Result Analytical Method Context` = sent question to S Apsens 2/8/2022, likely need to match in prior code chunk
    #`Method Speciation` = *
    ...
    # working here 2/8/2022, dozen or so more columns to go
