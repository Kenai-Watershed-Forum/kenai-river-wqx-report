...
###### Address which samples can be evaluated for RPD ##############
  ...
  # from DEC 2022 field report: "... a set of paired samples was evaluated for RPD only if: a.) one or both of the samples were above the PQL; AND if b.) one or both of the samples were at least two times the PQL." 
...
rpd_check_dat <- left_join(field_dup_dat_2021,above_loq) %>%
  ...
  # filter out rpd check data that does not meet LOQ criteria
  filter(loq_2x == "Y" & above_loq == "Y") %>%
