...
z <- rpd_check_dat %>%
  ...
  # replace non-detects with zero for Relative Percent Difference (RPD) calculations (DON'T DO THIS... AT THIS POINTIN WINNOWING, MISSING OBS ARE BECAUSE SAMPL WASNT COLLECTED, SEE NOT ON TRANSCRIPTION ERROR EARLIER)
  #replace(is.na(.), 0) 
