...
```{r, echo = F}
# filter out lab blanks and positive lab controls
dat %<>%
...
z <- dat %>%
  ...
  mutate(
   ...
   # `Statistical Base Code` = "", # may need to ask
    ...
    #`Result Sample Fraction` = need to assign based on sample collection type  ## create match table w/ analytical method. total metals = Unfiltered. diss metals = Filtered, field. tss = suspended. 
