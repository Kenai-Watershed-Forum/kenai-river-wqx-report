...
# 2/24/2022 - receiving EDD (electronic data deliverables) from ALS
...
# manually create transmission chain of site/sample names for spring 2021
# see excel document at other/input/2021_wqx_data/miscellaenous

# go though and document coc to decide what data we can defend inclusion/exclusion of
```
